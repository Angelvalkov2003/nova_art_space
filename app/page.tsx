          ...
          <div className="max-w-4xl">
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-8">
              <div className="bg-white/60 backdrop-blur-sm rounded-lg p-4 border border-[#E8E8E8]">
                <IconOffice className="w-8 h-8 mb-2 text-[#495464]" />
                <p className="text-sm font-semibold text-[#495464] mb-1">
                  400 кв.м
                </p>
                <p className="text-xs text-[#495464]/70">
                  Адаптивно пространство
                </p>
              </div>
              <div className="bg-white/60 backdrop-blur-sm rounded-lg p-4 border border-[#E8E8E8]">
                <IconTheater className="w-8 h-8 mb-2 text-[#495464]" />
                <p className="text-sm font-semibold text-[#495464] mb-1">
                  Подиум
                </p>
                <p className="text-xs text-[#495464]/70">Професионална сцена</p>
              </div>
              <div className="bg-white/60 backdrop-blur-sm rounded-lg p-4 border border-[#E8E8E8]">
                <IconLightBulb className="w-8 h-8 mb-2 text-[#495464]" />
                <p className="text-sm font-semibold text-[#495464] mb-1">
                  Осветление
                </p>
                <p className="text-xs text-[#495464]/70">Галерийно качество</p>
              </div>
            </div>
            <Link
              href="/subitiya"
